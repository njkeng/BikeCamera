...
Camera cable suitable for PiZero.  Pi Zero has a narrower connector than a large-format Pi
Pushbuttons
LEDs
Real time clock??
...
```sh
$ wget -q https://git.io/vpk26 -O /tmp/pihelmetcam && bash /tmp/pihelmetcam
```
